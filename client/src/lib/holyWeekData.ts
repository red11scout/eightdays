...
export const DAYS: DayData[] = [
  ...
  },
  {
    ...
    gospelHarmonyNote: "John alone records the foot washing and the extended Upper Room Discourse (chapters 13\u201317). The Synoptics focus on the institution of the Lord\u2019s Supper, which John omits. A significant chronological tension exists: the Synoptics present the Last Supper as the Passover meal itself (lambs slaughtered Thursday afternoon), while John\u2019s Gospel places the crucifixion at the hour the Passover lambs were being killed on Friday (John 18:28; 19:14). Proposed harmonizations include a two-calendar theory (Essene vs. Sadducean), or that Jesus deliberately ate the meal a day early knowing He would be dead by the official Passover. This tension is well-known in scholarship and does not undermine the historicity of either account; together they provide the complete picture of the evening.",
  },
  {
    id: "friday",
    dayNumber: 6,
